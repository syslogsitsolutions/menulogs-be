              ...
              <tr>
                <td style="padding: 40px 40px 30px 40px;">
                  ...
                  <p style="margin: 0 0 30px 0; font-size: 16px; color: #4b5563; line-height: 1.7;">
                    Thank you for signing up with MenuLogs! Please verify your email address by clicking the button below to complete your registration.
                  </p>
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td align="center" style="padding: 10px 0 30px 0;">
                        <a href="${verificationLink}" style="display: inline-block; padding: 14px 32px; background-color: #ee6620; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; text-align: center;">
                  ...
                  <div style="background-color: #fff5f0; border-left: 4px solid #ee6620; padding: 16px 20px; margin: 30px 0; border-radius: 4px;">
                    <p style="margin: 0 0 8px 0; font-size: 14px; color: #6b7280; line-height: 1.6;">
                      <strong style="color: #ee6620;">Security notice:</strong> This verification link will expire in <strong>24 hours</strong> for your security.
                    </p>
                    <p style="margin: 8px 0 0 0; font-size: 13px; color: #9ca3af; line-height: 1.5;">
                      If the button doesn't work, copy and paste this link into your browser: <span style="word-break: break-all; color: #6b7280;">${verificationLink}</span>
                    </p>
                  </div>
                  
                  <!-- Additional Info -->
                  <p style="margin: 0; font-size: 14px; color: #6b7280; line-height: 1.6;">
                    If you didn't create an account with MenuLogs, you can safely ignore this email.
                  </p>
                </td>
              </tr>
